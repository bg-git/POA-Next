...
type ChatTranscriptProps = {
  name?: string;
  messages: { sender: 'ME' | 'PIERCE OF ART', text: string }[];
};
...
export default function ChatTranscript({ name, messages }: ChatTranscriptProps) {
  return (
    <Html>
      <Head />
      <Preview>Your PIERCE OF ART chat transcript</Preview>
      <Body style={{ fontFamily: 'sans-serif', backgroundColor: '#f9f9f9' }}>
        <Container style={{ background: '#fff', padding: '24px', maxWidth: '600px', borderRadius: '8px', margin: 'auto' }}>
          ...
          <Text style={{ fontSize: '14px', color: '#777' }}>
            If you still need help, just reply to this email or visit us at <a href="https://pierceofart.co.uk">pierceofart.co.uk</a>.
          </Text>
        </Container>
      </Body>
    </Html>
