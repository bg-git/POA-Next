...
/>
              ...
              <div className="overlay">
                ...
                <div className="overlay-buttons">
                  <Link href="/collections/ends-gems" className="button">VIEW ALL ENDS & GEMS &#x27F6;</Link>
                </div>
              </div>
            </div>
          </div>
  ...
  fetchPriority="high"
              ...
              <div className="overlay">
                ...
                <div className="overlay-buttons">
                  <Link href="/collections/chains-charms" className="button">VIEW ALL CHAINS & CHARMS &#x27F6;</Link>
          ...
          <div className="custom-card">
            <div className="image-container">
              ...
              <div className="overlay">
                ...
                <div className="overlay-buttons">
                  <Link href="/collections/rings-hoops" className="button">VIEW ALL RINGS &#x27F6;</Link>
                </div>
              </div>
            </div>
          </div>
