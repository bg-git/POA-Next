...
const STUDIO_ID = 'b62f49a2-3b35-40bc-847d-79451d760498';

export default function StudioCalendarConnect() {
    ...
    <div className={styles.container}>
      <div className={styles.card}>
        ...
        <div className={styles.studioInfo}>
          <h2 className={styles.studioName}>Leicester Studio</h2>
          <p className={styles.studioId}>ID: {STUDIO_ID}</p>
        </div>

        <div className={styles.content}>
          <p className={styles.contentText}>
            Click the button below to connect your Leicester studio&apos;s Google Calendar. 
